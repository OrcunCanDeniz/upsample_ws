...
try:
    ...
    # from bevdepth.ops.voxel_pooling3d_inference import voxel_pooling_train
    from bevdepth.ops.voxel_pooling3d_train import voxel_pooling3d_train
...
class BaseLSSFPN(nn.Module):
    ...
    def __init__(self,
        ...
        self.pool_train = voxel_pooling3d_train if pool3d else voxel_pooling_train
        self.pool_inference = voxel_pooling3d_inference if pool3d else voxel_pooling_inference
    ...
    def _forward_single_sweep(self,
        ...
        if self.training or self.use_da:
            ...
            feature_map = self.pool_train(geom_xyz,
                                              img_feat_with_depth.contiguous(),
                                              self.voxel_num.cuda())
        else:
            feature_map = self.pool_inference(
