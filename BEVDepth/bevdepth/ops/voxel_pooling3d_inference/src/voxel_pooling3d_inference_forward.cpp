...
int voxel_pooling3d_inference_forward_wrapper(
...
void voxel_pooling3d_inference_forward_kernel_launcher(
    int batch_size, int num_cams, int num_depth, int num_height, int num_width,
    int num_channels, int num_voxel_x, int num_voxel_y, int num_voxel_z,
...
int voxel_pooling3d_inference_forward_wrapper(
  ...
  if (depth_features_tensor.dtype() == at::kFloat) {
    ...
    voxel_pooling3d_inference_forward_kernel_launcher(
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("voxel_pooling3d_inference_forward_wrapper",
        &voxel_pooling3d_inference_forward_wrapper,
        "voxel_pooling3d_inference_forward_wrapper");
}
