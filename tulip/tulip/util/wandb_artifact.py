...
class WandbArtifactHook:
    ...
    def __init__(self, 
        ...
        self.s3_bucket = "wandb-artifacts-dnp"
...
if __name__ == "__main__":
    """
    Test block for WandbArtifactHook functions
    """
    import tempfile
    from pathlib import Path
    
    print("Testing WandbArtifactHook functions...")
    
    # Create a temporary directory for testing
    with tempfile.TemporaryDirectory() as temp_dir:
        # Create some dummy checkpoint files
        
        # Initialize the WandbArtifactHook
        hook = WandbArtifactHook(
            wandb_entity="pnp_dnp",
            wandb_project="upsample", 
            dir_path=temp_dir,
            use_s3=True
        )
        hook.before_run(output_dir=temp_dir, logger=None)
        ...
        for filename in checkpoint_files:
            ...
            file_path.write_text(f"Dummy checkpoint content for {filename}")
        
        print(f"Created test files in: {temp_dir}")
      
        hook.log_wandb()
        print("✓ log_wandb executed successfully")
